...
<div class="row">
    <div class="col-md-12">
        @include('field_staff.dashboard.partials.report_basic_farmer_profile')
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        @include('field_staff.dashboard.partials.monthly_progress_report')
        
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        @include('field_staff.dashboard.partials.monthly_training_report')
