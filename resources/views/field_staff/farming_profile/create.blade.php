    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Add New Farming Profile</h5>
            ...
            <div class="card-body">
                <form action="{{route('field_staff.farming_profile.store')}}" method="post" enctype="multipart/form-data" >
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="involvement_in_fishery" value="Nursery Farmer" class=""> Nursery Farmer 
                                <input type="radio" name="involvement_in_fishery" value="Grower" class=""> Grower 
                                <input type="radio" name="involvement_in_fishery" value="Both" class=""> Both 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_pump_set" value="1" class=""> Yes 
                                <input type="radio" name="have_pump_set" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Have Boring or tube well ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_tube_well" value="1" class=""> Yes 
                                <input type="radio" name="have_tube_well" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Fishing Net ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="fishing_net" value="1" class=""> Yes 
                                <input type="radio" name="fishing_net" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Aereator ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="aereator" value="1" class=""> Yes 
                                <input type="radio" name="aereator" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Have you clean pond boundary Regularly ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_boundary_regularly" value="1" class=""> Yes 
                                <input type="radio" name="have_boundary_regularly" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Have you remove black soil or mud during last 3 years ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_remove_black_soil" value="1" class=""> Yes 
                                <input type="radio" name="have_remove_black_soil" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Have you applied lime during pond preparation in last year ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_applied_lime" value="1" class=""> Yes 
                                <input type="radio" name="have_applied_lime" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Have you apply cow dung during pond preparation in last year ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_apply_cow_dung" value="1" class=""> Yes 
                                <input type="radio" name="have_apply_cow_dung" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Have you regularly applied lime after stocking in last year ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_regularly_apply_lime" value="1" class=""> Yes 
                                <input type="radio" name="have_regularly_apply_lime" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Have you regularly applied cow dung or organic fertiliser after stocking in last year ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_regularly_apply_cow_dung" value="1" class=""> Yes 
                                <input type="radio" name="have_regularly_apply_cow_dung" value="0" class=""> No 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="type_of_feed_used" value="MOC" class=""> MOC 
                                <input type="radio" name="type_of_feed_used" value="Sinking" class=""> Sinking  
                                <input type="radio" name="type_of_feed_used" value="Floating" class=""> Floating  
                            </div>
                        </div>
                        <div class="form-group col-md-3">
                            <label>Have you done feeding regularly ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="done_feeding_regularly" value="1" class=""> Yes 
                                <input type="radio" name="done_feeding_regularly" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-3">
                            <label>Have you checked Water PH regularly ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_water_ph_regularly" value="1" class=""> Yes 
                                <input type="radio" name="have_water_ph_regularly" value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-3">
                            <label>Have you done meeting regularly ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="have_meeting_regularly" value="1" class=""> Yes 
                                <input type="radio" name="have_meeting_regularly" value="0" class=""> No 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="attend_training_programme" value="1" class=""> Yes 
                                <input type="radio" name="attend_training_programme" value="0" class=""> No  
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Have you ever made exposure to good practices of fish farming ?</label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="exposure_good_practics" value="1" class=""> Yes 
                                <input type="radio" name="exposure_good_practics" value="0" class=""> No  
                            </div>
                        </div>
                    </div>
