					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu {{Request::is('project/report*') ?'nav-item-open':''}}">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('project/report*')   ?'display:block':''}}">
								...
								<li class="nav-item"><a href="{{route('project.report.respondent_master')}}" class="nav-link {{Request::is('project/report/respondent_master') ?'active':''}}">Respondent Master</a></li>
								<li class="nav-item"><a href="{{route('project.framing.profile')}}" class="nav-link {{Request::is('project/report/framing_profile') ?'active':''}}">Farming Profile</a></li>
								<li class="nav-item"><a href="{{route('project.report.monthly-framing')}}" class="nav-link {{Request::is('project/report/monthly-framing') ?'active':''}}">Monthly Framing report</a></li>
								<li class="nav-item"><a href="{{route('project.report.total-training')}}" class="nav-link {{Request::is('project/report/total-training') ?'active':''}}">Total Training Report</a></li>
							</ul>
						</li>
					</ul>
				</div>
