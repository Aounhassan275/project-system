<div class="card">
    ...
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Report on Basic Farmer Profile -Whole Project</h5>
    ...
    <div class="card-body">
        <table class="table datatable-save-state">
            <thead>
                <tr>
                    <th rowspan="2" class="text-center">Name of District</th>
            ...
            <tbody>
                ...
                @endphp
                <tr>
                    <td class="text-center">{{$gramPanchyat->block && $gramPanchyat->block->district ? $gramPanchyat->block->district->name : ''}}</td>
