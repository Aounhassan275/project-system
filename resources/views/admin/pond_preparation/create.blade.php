    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Add New Pond Preparation</h5>
            ...
            <div class="card-body">
                <form action="{{route('admin.pond_preparation.store')}}" method="post" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="repair_pond_boundary" required value="1" class=""> Yes 
                                <input type="radio" name="repair_pond_boundary" required value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4 repair_pond_boundary_field"  hidden>
                            <label>Date of Cleaning and Repairing pond Boundary</label>
                            <input type="date" name="date_of_pond_boundary" class="form-control">
                        </div>
                        <div class="form-group col-md-4 repair_pond_boundary_field"  hidden>
                            <label>Expenditure of Cleaning and Repairing pond Boundary</label>
                            <input type="text" name="expenditure_of_pond_boundary" class="form-control">
                        </div>
                        <div class="form-group col-md-4 repair_pond_boundary_field"  hidden>
                            ...
                            <select  name="observation_of_pond_boundary"  class="form-control select-search" data-fouc>
                                <option selected disabled>Select Observation</option>
                                <option value="Excellent">Excellent</option>
                                <option value="Good">Good</option>
                                <option value="Average">Average</option>
                                <option value="Need to Clean">Need to Clean</option>
                                <option value="Repair it again">Repair it again</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Have you remove black soil or mud??</label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="remove_black_soil" required value="1" class=""> Yes 
                                <input type="radio" name="remove_black_soil" required value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4 remove_black_soil_field"  hidden>
                            <label>Date of removal of black soil or mud</label>
                            <input type="date" name="date_black_soil" class="form-control">
                        </div>
                        <div class="form-group col-md-4 remove_black_soil_field"  hidden>
                            <label>Expenditure of removal of black soil or mud</label>
                            <input type="text" name="expenditure_black_soil" class="form-control">
                        </div>
                        <div class="form-group col-md-4 remove_black_soil_field"  hidden>
                        ...
                        <div class="form-group col-md-4" >
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="is_sun_drying" required value="1" class=""> Yes 
                                <input type="radio" name="is_sun_drying" required value="0" class=""> No 
                            </div>
                        </div>
                        <div class="form-group col-md-4 is_sun_drying_field" hidden>
                            <label>From</label>
                            <input type="date" name="from_sun_drying" class="form-control">
                        </div>
                        <div class="form-group col-md-4 is_sun_drying_field" hidden>
                            <label>To</label>
                            <input type="date" name="to_sun_drying" class="form-control">
                        </div>
                        <div class="form-group col-md-3">
                            <label>Have you done liming ? </label>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="is_done_liming" required value="1" class=""> Yes 
                                <input type="radio" name="is_done_liming" required value="0" class=""> No 
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="is_cow_dung" required value="1" class=""> Yes 
                                <input type="radio" name="is_cow_dung" required value="0" class=""> No 
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="radio" name="is_apply_npk" required value="1" class=""> Yes 
                                <input type="radio" name="is_apply_npk" required value="0" class=""> No 
                            </div>
                        </div>
                    </div>
