...
@section('title')
    {{$training_report->name}} Training Report
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">{{$training_report->name}}  Training Report</h5>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-12 text-center">
                        <img src="{{asset($training_report->image)}}"  alt="">
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" value="{{$training_report->number_of_participants}}" name="number_of_participants"  placeholder="Number of Participants" class="form-control" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Number of Male</label>
                        <input type="number" name="number_of_male"  value="{{$training_report->number_of_male}}" placeholder="Number of Male" class="form-control" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Number of Female</label>
                        <input type="number" name="number_of_female"  value="{{$training_report->number_of_female}}" placeholder="Number of Female" class="form-control" required>
                    </div>
                </div>
            </div>
        </div>
